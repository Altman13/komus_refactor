...
/*---------------------------------------------*/         	
            ...
            $rep_name = 'base';
             ...
             $sql_report_string = "
                SELECT contact.*, DATE_FORMAT(contact.creation_time, '%d.%m.%Y') begin_date, u.user_lastname, u.user_firstname,
           ...
           $sheet->write(0, 36, iconv('utf-8', 'windows-1251', 'ID контакта'), $formatHeader);
            ...
            foreach ($sql_report as $key => $row) {            	
				...
				$sheet->write(1 + $row_num, 0, iconv('utf-8', 'windows-1251', clear_simbol($row['fio'])), $formatCell);
				$sheet->write(1 + $row_num, 1, iconv('utf-8', 'windows-1251', clear_simbol($row['policenumber'])), $formatCell);
				$sheet->write(1 + $row_num, 2, iconv('utf-8', 'windows-1251', clear_simbol($row['productnumber'])), $formatCell);
				$sheet->write(1 + $row_num, 3, iconv('utf-8', 'windows-1251', clear_simbol($row['productname'])), $formatCell);
				
				$sheet->write(1 + $row_num, 4, iconv('utf-8', 'windows-1251', clear_simbol($row['currency'])), $formatCell);
				$sheet->write(1 + $row_num, 5, iconv('utf-8', 'windows-1251', clear_simbol($row['contractdate'])), $formatCell);
               
				$sheet->write(1 + $row_num, 6, iconv('utf-8', 'windows-1251', clear_simbol($row['dateend'])), $formatCell);				
				$sheet->write(1 + $row_num, 7, iconv('utf-8', 'windows-1251', clear_simbol($row['period'])), $formatCell);
				$sheet->write(1 + $row_num, 8, iconv('utf-8', 'windows-1251', clear_simbol($row['premium'])), $formatCell);
								
				$sheet->write(1 + $row_num, 9, iconv('utf-8', 'windows-1251', clear_simbol($row['summ'])), $formatCell);
				$sheet->write(1 + $row_num, 10, iconv('utf-8', 'windows-1251', clear_simbol($row['profit'])), $formatCell);				
				$sheet->write(1 + $row_num, 11, iconv('utf-8', 'windows-1251', clear_simbol($row['profityear'])), $formatCell);
				$sheet->write(1 + $row_num, 12, iconv('utf-8', 'windows-1251', clear_simbol($row['bank'])), $formatCell);
				$sheet->write(1 + $row_num, 13, iconv('utf-8', 'windows-1251', clear_simbol($row['segment'])), $formatCell);
				$sheet->write(1 + $row_num, 14, iconv('utf-8', 'windows-1251', clear_simbol($row['strategy'])), $formatCell);
				$sheet->write(1 + $row_num, 15, iconv('utf-8', 'windows-1251', clear_simbol($row['marketname'])), $formatCell);
				$sheet->write(1 + $row_num, 16, iconv('utf-8', 'windows-1251', clear_simbol($row['region'])), $formatCell);
				$sheet->write(1 + $row_num, 17, iconv('utf-8', 'windows-1251', clear_simbol($row['city'])), $formatCell);
				$sheet->write(1 + $row_num, 18, iconv('utf-8', 'windows-1251', clear_simbol($row['birthdate'])), $formatCell);
				$sheet->write(1 + $row_num, 19, iconv('utf-8', 'windows-1251', clear_simbol($row['address'])), $formatCell);
				$sheet->write(1 + $row_num, 20, iconv('utf-8', 'windows-1251', clear_simbol($row['phone1'])), $formatCell);
				$sheet->write(1 + $row_num, 21, iconv('utf-8', 'windows-1251', clear_simbol($row['phone2'])), $formatCell);
				$sheet->write(1 + $row_num, 22, iconv('utf-8', 'windows-1251', clear_simbol($row['email'])), $formatCell);
				$sheet->write(1 + $row_num, 23, iconv('utf-8', 'windows-1251', clear_simbol($row['office'])), $formatCell);
				  				
				$sheet->write(1 + $row_num, 24, iconv('utf-8', 'windows-1251', getReferenceItem($row['status1'])), $formatCell);
				$sheet->write(1 + $row_num, 25, iconv('utf-8', 'windows-1251', getReferenceItem($row['status2'])), $formatCell);
				$sheet->write(1 + $row_num, 26, iconv('utf-8', 'windows-1251', getReferenceItem($row['status3'])), $formatCell);
				$sheet->write(1 + $row_num, 27, iconv('utf-8', 'windows-1251', getReferenceItem($row['status4'])), $formatCell);

				$sheet->write(1 + $row_num, 28, iconv('utf-8', 'windows-1251', clear_simbol($row['date_meat'])), $formatCell);
				
				$sheet->write(1 + $row_num, 29, iconv('utf-8', 'windows-1251', getReferenceItem($row['tech1'])), $formatCell);
				$sheet->write(1 + $row_num, 30, iconv('utf-8', 'windows-1251', getReferenceItem($row['tech2'])), $formatCell);
				$sheet->write(1 + $row_num, 31, iconv('utf-8', 'windows-1251', getReferenceItem($row['tech3'])), $formatCell);
								
				$sheet->write(1 + $row_num, 32, iconv('utf-8', 'windows-1251', $row['comment']), $formatCell);
				
				$sheet->write(1 + $row_num, 33, iconv('utf-8', 'windows-1251', $row['begin_date']), $formatCell);  // дата звонка
				$sheet->write(1 + $row_num, 34, iconv('utf-8', 'windows-1251', $row['begin_time']), $formatCell);  // время звонка
				
				
				$sheet->write(1 + $row_num, 35, iconv('utf-8', 'windows-1251', $row['user_lastname'] . ' ' . $row['user_firstname']), $formatCell); 
                $sheet->write(1 + $row_num, 36, iconv('utf-8', 'windows-1251', $row['id']), $formatCell);
